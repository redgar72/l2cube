...
export const CUBE_MASKS = {
  ...
  CROSS_ONLY: "CORNERS:GGGGGGGG,EDGES:----GGGGGGGG,CENTERS:-GGGGG",
  
  // Show only corners (for corner-specific algorithms)
  CORNERS_ONLY: "CORNERS:DDDDDDDD,EDGES:GGGGGGGGGGGG,CENTERS:GGGGGG",
  
  // Show only edges (for edge-specific algorithms)
  EDGES_ONLY: "CORNERS:GGGGGGGG,EDGES:DDDDDDDDDDDD,CENTERS:GGGGGG",
  
  // Show only F2L pieces (corners and edges, hide centers)
  F2L_ONLY: "CORNERS:DDDDDDDD,EDGES:DDDDDDDDDDDD,CENTERS:GGGGGG",
  
  // Show only OLL pieces (top layer)
  OLL_ONLY: "CORNERS:DDDDDDDD,EDGES:DDDDDDDDDDDD,CENTERS:GGGGGG",
  
  // Show only PLL pieces (top layer)
  PLL_ONLY: "CORNERS:DDDDDDDD,EDGES:DDDDDDDDDDDD,CENTERS:GGGGGG",
